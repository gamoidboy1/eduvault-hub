      ...
      <div style="display:flex; align-items:center;">
        <div class="header-brand" onclick="App.switchView('dashboard')"
          ...
          <div style="width:30px;height:30px;background:var(--red);border-radius:0px;
            ...
            <span style="font-size:.75rem;font-weight:900;color:#fff;letter-spacing:-.5px;">EV</span>
          </div>
          <div class="brand-text-container">
              <div class="title" style="font-family: 'Inter', sans-serif; font-weight: 800; text-transform: uppercase; letter-spacing: 1px;">EduVault</div>
